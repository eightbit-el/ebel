...
<details>
<summary>第3回： 情報漏えいを防ぐための基礎知識とリスク理解 </summary>
<div>
**受講内容:** 資料の指定範囲を熟読し、理解度チェックを実施してください。

**学習目的:** 脆弱性悪用に関する理解と対策の習得 
- **読み込み範囲:**  
  - 情報セキュリティ10大脅威:  P.52～P.57   
        資料: [PDF資料（IPA公式）](https://www.ipa.go.jp/security/10threats/nq6ept000000g22h-att/kaisetsu_2024.pdf)
- **内容:**  
  1. 脆弱性を悪用した攻撃  
  2. 不注意による情報漏えい
  ...
  4. ビジネスメール詐欺による金銭被害
- **理解度チェック:**  
  - 確認テスト: [第三回_理解度チェック](https://forms.gle/Er1R9kTmYceQ66oo9) 
</div>
</details>

<details>
<summary>第4回： VPN・Web会議のリスクと、ダークウェブ取引</summary>
<div>
**受講内容:** 資料の指定範囲を熟読し、理解度チェックを実施してください。  
...
- **読み込み範囲:**  
  - 情報セキュリティ10大脅威:  P.58～P.61 
        資料: [PDF資料（IPA公式）](https://www.ipa.go.jp/security/10threats/nq6ept000000g22h-att/kaisetsu_2024.pdf)
- **内容:**  
  1. テレワーク等のニューノーマルな働き方を狙った攻撃  
  2. 犯罪のビジネス化（アンダーグラウンドサービス）  
  ...
  9. 情報共有と連携   -->
- **理解度チェック:**  
  - 確認テスト: [第四回_理解度チェック](https://forms.gle/eF6sBFwnVnkARwah7) 
</div>
</details>
